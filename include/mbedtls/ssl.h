...
/* Largest ECDH shared secret for the curves PSA Crypto is configured with. */
#define MBEDTLS_SSL_ECDH_MAX_BYTES \
...
union mbedtls_ssl_premaster_secret {
    ...
    unsigned char _pms_ecdh[MBEDTLS_SSL_ECDH_MAX_BYTES]; /* RFC 4492 5.10 */
#endif
#if defined(MBEDTLS_KEY_EXCHANGE_PSK_ENABLED)
    unsigned char _pms_psk[4 + 2 * MBEDTLS_PSK_MAX_LEN];       /* RFC 4279 2 */
#endif
#if defined(MBEDTLS_KEY_EXCHANGE_ECDHE_PSK_ENABLED)
    unsigned char _pms_ecdhe_psk[4 + MBEDTLS_SSL_ECDH_MAX_BYTES
